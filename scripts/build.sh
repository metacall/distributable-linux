...
# Build
guix build metacall metacall-python-port --fallback -L /metacall/nonguix -L /metacall/source --without-tests=node-lts --without-tests=libnode  --without-tests=node-18.19.0
